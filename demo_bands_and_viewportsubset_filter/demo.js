$(document).ready(function () {
  ...
  //load COG
  const rasterUrl = "soilmoisture_cog.tif";
  ...
  //function to be called each time the viewport is altered
  ...
  $("#band").on("change", (event) => {
    const band = $("#band option:selected").val();
    rasterLayer.options.band = band;
    collectGeoTiffSubset(band);
  });
